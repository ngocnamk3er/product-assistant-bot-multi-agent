...
MILVUS_COLLECTION_NAME = (
    "policy_knowledge_base_chunks"  # <<< THAY THẾ BẰNG TÊN COLLECTION CỦA BẠN
)
...
TEXT_CONTENT_FIELD_NAMES = [
    "chunk_text"  # <<< THAY THẾ BẰNG TÊN TRƯỜNG CHỨA NỘI DUNG TEXT
]
...
class PolicyQAAgent:
    ...
    def _build_agent(self) -> LlmAgent:
        ...
        return LlmAgent(
            ...
            description="Trợ lý AI chuyên cung cấp thông tin về các chính sách và quy định",
            instruction=(
